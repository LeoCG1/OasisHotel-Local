@extends('layouts.app')
@section('titulo', 'Familiar')
@section('contenido')


<div id="carouselFamiliar" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouselFamiliar" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
        <button type="button" data-bs-target="#carouselFamiliar" data-bs-slide-to="1" aria-label="Slide 2"></button>
        <button type="button" data-bs-target="#carouselFamiliar" data-bs-slide-to="2" aria-label="Slide 3"></button>
        <button type="button" data-bs-target="#carouselFamiliar" data-bs-slide-to="3" aria-label="Slide 4"></button>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="/fotos/habitacion/bedroom-gef7538ff0_1280.jpg" class="d-block w-100 img-fluid" alt="foto habitacion Familiar con cama del hotel">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="/fotos/habitacion/bath-g0c2387793_1280.jpg" class="d-block w-100 img-fluid" alt="foto del baño de la habitación Familiar">
        </div>
        <div class="carousel-item">
            <img src="/fotos/habitacion/modern-minimalist-lounge-g602205d4b_1280.jpg" class="d-block w-100 img-fluid" alt="foto del salon de la habitación Familiar">
        </div>
        <div class="carousel-item">
            <img src="/fotos/habitacion/living-room-gc9e419b38_1280.jpg" class="d-block w-100 img-fluid" alt="foto del salon Familiar">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselFamiliar" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselFamiliar" data-bs-slide="next">
...
<div class="container">
    <div class="row text-center">
        <div class="col-12">
            <p>Habitación grande para familias numerosas o grandes grupos, equipada con 1 cama de matrimonio, una cama King-size, con baño individual para cada una</p>
        </div>
    </div>
</div>
    ...
    <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionSuite">
            <div class="accordion-body">
                <ul>
                    <li>Cama de tamaño King Size de 1,80m x 2,10m + cama individual de 1,0m x 2,10.</li>
                    <li>Cama matrimonial de 1,50m x 2,10m.</li>
                    <li>Cama individuales de 1,0m x 2,10m</li>
                    <li>Baño individual</li>
...
<div class="container serviciosFamiliar scroll-content fadeRight">
    <div class="row text-center reservaMargenFamiliar">
        <div class="col-12">
    ...
    <div class="row scroll-content fadeLeft">
        ...
        <div class="col-sm-6 col-md-4 col-lg-2">
            <img src="/iconos/lavanderia.png" alt="icono de una lavadora">
    ...
    <div class="row scroll-content fadeRight">
        ...
        <div class="col-sm-6 col-md-4 col-lg-2">
            <img src="/iconos/vehiculo.png" class="img-fluid" alt="icono de un vehiculo con un letrero de aparcamiento">
...
<div class="container">
    <div class="row text-center">
        <div class="col-12">
            <h2 class="encuentraHabitacionFamiliar">Encuentra tu habitación ideal</h2>
        </div>
    </div>
    <div class="row cartaHabitacionesFamiliar scroll-content fadeLeft">
        <div class="col-sm-12 col-md-6 col-lg-6 margenHab">
            ...
            <div class="entrar">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="iconosHabitacionCardFamiliar">
                        <img src="/iconos/familia (1).png" alt="icono de una familia img-fluid">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="entrar">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('suite') }}" class="btn btn-primary mx-auto d-block verMas">Ver Más</a>
                </div>
            </div>
        </div>
    </div>
