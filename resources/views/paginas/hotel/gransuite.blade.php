@extends('layouts.app')
@section('titulo', 'Gran Suite')
@section('contenido')


<div id="carouselGranSuite" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
          <button type="button" data-bs-target="#carouselGranSuite" data-bs-slide-to="0" class="active"
            aria-current="true" aria-label="Slide 1"></button>
          <button type="button" data-bs-target="#carouselGranSuite" data-bs-slide-to="1" aria-label="Slide 2"></button>
          <button type="button" data-bs-target="#carouselGranSuite" data-bs-slide-to="2" aria-label="Slide 3"></button>
          <button type="button" data-bs-target="#carouselGranSuite" data-bs-slide-to="3" aria-label="Slide 4"></button>
        </div>
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img src="/fotos/habitacion/bedroom-ga50455b85_1280.jpg" class="d-block w-100 img-fluid" alt="foto habitacion Gran Suite con cama del hotel">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="/fotos/habitacion/bathroom-g88b5c2e53_1280.jpg" class="d-block w-100 img-fluid"
              alt="foto del baño Gran suite">
          </div>
          <div class="carousel-item">
            <img src="/fotos/habitacion/dining-room-g26cdc87bb_1280.jpg" class="d-block w-100 img-fluid" alt="foto de la mesa del salon de la habitación Gran Suite">
          </div>
          <div class="carousel-item">
            <img src="/fotos/habitacion/living-room-g73a56e866_1280.jpg" class="d-block w-100 img-fluid"
              alt="foto del salon Gran Suite">
          </div>
        </div>
      ...
      <div class="container">
        <div class="row text-center">
            <div class="col-12">
                <p>Habitación para familia con cada de 1,50m x 2,10m con baño individual</p>
            </div>
        </div>
    </div>
    ...
    <div class="container servicios">
      <div class="row text-center reservaMargen scroll-content fadeRight">
          <div class="col-12">
      ...
      <div class="row scroll-content fadeLeft">
          ...
          <div class="col-sm-6 col-md-4 col-lg-2">
              <img src="/iconos/cortinas.png" class="img-fluid" alt="icono de unas cortinas">
              <h3>Cortinas de oscurecimiento</h3>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-2">
              <img src="/iconos/almohada.png" class="img-fluid" alt="icono de almohada">
      ...
      <div class="row scroll-content fadeRight">
          <div class="col-sm-6 col-md-4 col-lg-2">
              <img src="/iconos/ordenador-portatil.png" class="img-fluid" alt="icono de un portatil con señal wifi">
          ...
          <div class="col-sm-6 col-md-4 col-lg-2">
              <img src="/iconos/tv-ancha.png" class="img-fluid" alt="icono de una tv">
              <h3>Televisor pantalla plana</h3>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-2">
              <img src="/iconos/vehiculo.png" class="img-fluid" alt="icono de un coche con un letrero de parking">
    ...
    <div class="container">
      <div class="row text-center">
          <div class="col-sm-12 col-md-6 col-lg-6">
              <h2 class="encuentraHabitacion">Encuentra tu habitación ideal</h2>
          </div>
      </div>
      <div class="row cartaHabitaciones scroll-content fadeLeft">
          <div class="col-sm-12 col-md-6 col-lg-6 margenHab">
              <div class="card border-success">
              <div class="entrar">
                <a href="{{ route('suite') }}"><img src="/fotos/habitacion/bed-g3405a70a4_1280.jpg" class="card-img-top imagenEntrar img-fluid" alt="foto habitación gran suite"></a>
                <div class="iconoEntrarHab">
                    <img src="/iconos/entrar.png" class="iconoEntrar">
                </div>
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Suite</h5>
                    <div class="iconosHabitacionCard">
                      <img src="/iconos/familia (1).png" class="iconoCentro img-fluid" alt="icono de una familia">
