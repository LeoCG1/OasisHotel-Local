  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto" id="linksdesplazar">
        <li class="nav-item">
          <a class="nav-link subrallado estiloTexto" style="color:#6abfa5; font-size:1.5vw; font-weight: bolder;" aria-current="page" href="/#habitaciones">Habitaciones</a>
        </li>
        <li class="nav-item">
          <a class="nav-link subrallado estiloTexto" style="color:#6abfa5; font-size:1.5vw; font-weight: bolder;"  href="{{ route('servicios') }}">Servicios</a>
        </li>
        <li class="nav-item">
          <a class="nav-link subrallado estiloTexto" style="color:#6abfa5; font-size:1.5vw; font-weight: bolder;"  href="/#galeria">Galeria</a>
        </li>
        <li class="nav-item">
          <a class="nav-link subrallado estiloTexto" style="color:#6abfa5; font-size:1.5vw; font-weight: bolder;"  style="color:#6abfa5;"  href="/#ubicacion">Ubicación</a>
        </li>
        <li class="nav-item">
          <a class="nav-link subrallado estiloTexto" style="color:#6abfa5; font-size:1.5vw; font-weight: bolder;"  href="{{ route('comments.index') }}">Opiniones</a>
        </li>
      </ul>
      <ul class="navbar-nav ms-auto informacion estiloTexto">
        <li class="nav-item">
